...
$_sqldata = [];
if (EDIT_ID > 0) {
	$s = $DBConn->prepare('SELECT * FROM my_collaborator WHERE id = :id ;');
...
$form_register = new Form('my_collaborator', [
	new Field('id', 'int', '#ID', true),

	new Field('firstname', 'name', 'Firstname', true),
	new Field('lastname', 'name', 'Lastname', true),
	new Field('email', 'email', 'Active', true),
					...
					<div class="col-12">
						...
						<section class="card card-primary shadow-none">
							<div class="card-header">
								<h3><?php if ($form_register->get_field_value('id') != '') { ?>Edit Collaborator<?php } else { ?>New Collaborator<?php } ?></h3>
							</div>
									...
									<div class="col-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" name="firstname" id="firstname" placeholder="..."
												value="<?php echo $form_register->get_field_value_esc('firstname'); ?>">
										</div>
									</div>
									<div class="col-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" name="lastname" id="lastname" placeholder="..."
												value="<?php echo $form_register->get_field_value_esc('lastname'); ?>">
										</div>
									</div>
									<div class="col-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" name="email" id="email" placeholder="..."
												value="<?php echo $form_register->get_field_value_esc('email'); ?>">
										</div>
									</div>
								</div>
							</div>
