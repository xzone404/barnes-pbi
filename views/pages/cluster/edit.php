...
$_sqldata = [];
if (EDIT_ID > 0) {
	$s = $DBConn->prepare('SELECT * FROM my_cluster WHERE id = :id ;');
...
$form_register = new Form('my_cluster', [
	new Field('id', 'int', '#ID', true),

	new Field('name', 'name', 'Cluster\'s name', true),
					...
					<div class="col-12">
						...
						<section class="card card-primary shadow-none">
							<div class="card-header">
								<h3><?php if ($form_register->get_field_value('id') != '') { ?>Edit Cluster<?php } else { ?>New Cluster<?php } ?></h3>
							</div>
							<div class="card-body container">
								<div class="row">
									<div class="col-12">
										<div class="mb-3">
											<label for="name" class="form-label">Cluster's name :</label>
